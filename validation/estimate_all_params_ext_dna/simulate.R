...
library(FossilSim)
library(R.utils)
source("/Users/jugne/Documents/Source/beast2.7/sRanges-material/validation/estimate_all_params_priors/helper.R")
...
'%notin%' <- Negate('%in%')
wd <- "~/Documents/Source/beast2.7/sRanges-material/validation/estimate_all_params_priors/"
templates_dir <- "~/Documents/Source/beast2.7/sRanges-material/validation/estimate_all_params_priors/templates/"
