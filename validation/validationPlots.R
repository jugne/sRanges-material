...
test_vals <- function(prob, true=0, estimated=c()){
  # vals <- numeric(20)
  # vals = data.frame("0"=numeric(), "5"=numeric(), "10"=numeric(), "15"=numeric(), "20"=numeric(),
  #                   "25"=numeric(), "30"=numeric(), "35"=numeric(), "40"=numeric(), "45"=numeric(),
  #                   "50"=numeric(), "55"=numeric(), "60"=numeric(), "65"=numeric(),
  #                   "70"=numeric(), "75"=numeric(), "80"=numeric(), "85"=numeric(),
  #                   "90"=numeric(), "100"=numeric())
  # colnames(vals)<- c("0", "5", "10", "15", "20", "25", "30", "35", "40", "45",
...
true_rates_file <- "/Users/jugne/Documents/Source/beast2.7/sRanges-material/validation/true_rates.csv"
