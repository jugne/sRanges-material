...
write.csv(rbind(sp_first, sp_both),"~/Documents/Source/beast2.7/sRanges-material/canids/figures/canid_range_dates.csv")
...
# wd <- "~Documents/Source/beast2.7/sRanges-material/canids/SRFBD_rho_new_dates1_/tipAgeRelog/"
name <- "morph_on_both"
log <- read.table("~/Documents/Source/beast2.7/sRanges-material/canids/SRFBD_rho_new_dates_morph_first_last1/tipAgeRelog/canidae_rho.tipAge.log", header = T, )

all <- get_sRange_full(log)
ranges_full_s <- all[[1]]
ranges_full_e <- all[[2]]

p<-ggplot(ranges_full_s, aes(x = range, y = start_r_iqr_prior/start_r_iqr)) +
  geom_point(aes(color = "First"), size = 3, alpha=0.7) + 
...
ggsave(paste0("~/Documents/Source/beast2.7/sRanges-material/canids/figures/canid_SRFBD_",name,"_IQR.pdf"), width=25, height=8)
# ggsave("~/Documents/Source/beast2.7/sRanges-material/canids/figures/canid_IQR_only_range.pdf", width=23, height=8)


# wd <- "~Documents/Source/beast2.7/sRanges-material/canids/SRFBD_rho_new_dates1_/tipAgeRelog/"
name <- "combined"
log1 <- read.table("~/Documents/Source/beast2.7/sRanges-material/canids/SRFBD_rho_new_dates1_/tipAgeRelog/canidae_rho.tipAge.log", header = T, )
...
p<-ggplot(ranges_full_s_comb, aes(x = range, y = start_r_iqr_prior/start_r_iqr)) +
  ...
  theme(legend.position = "None", 
        legend.background = element_rect(fill="white", 
                                         linewidth=0.5, linetype="solid"),
        legend.justification = c("right", "bottom"), legend.box = "horizontal",text=element_text(size=21),
        axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+ 
  guides(color = guide_legend(override.aes = list(shape=15, size=5) ) )

ggsave(paste0("~/Documents/Source/beast2.7/sRanges-material/canids/figures/canid_SRFBD_",name,"_IQR_noLegend.pdf"), width=25, height=8)
