...
source("~/Documents/Source/beast2.7/sRanges-material/validation/estimate_all_params_ext_dna/helper.R")
...
## change paths if needed
wd <- "~/Documents/Source/beast2.7/sRanges-material/validation/estimate_all_params_ext_dna/"
templates_dir <- "~/Documents/Source/beast2.7/sRanges-material/validation/estimate_all_params_ext_dna/templates/"
