...
for (folder in c("estimate_all_params_ext_dna", "estimate_all_params_full_dna")){
  
  # Set the directory to the directory of the file
  # wd<-"/Users/jugne/Documents/Source/beast2.7/sRanges-material/validation/estimate_all_params_ext_dna/"
  # setwd(wd)
  dir.create(paste0(folder,"/figures"))
  
  # read in the true rates
  true_rates_file <- paste0(folder, "/true_rates.csv")
  ...
  diversificationRate = data.frame(true=numeric(n), estimated=numeric(n),
                                   ...
                                   test_100=numeric(n))
  turnover = diversificationRate
  samplingProportion = diversificationRate
  samplingAtPresentProb = diversificationRate
  origin = diversificationRate
  mrca = diversificationRate
  rsamplingAtPresentProb = diversificationRate
  ...
  for (i in 1:n){
    ...
    log <- list.files(path=paste0(folder, "/run_",i,"/inf"), pattern=paste0("sRanges.",i,".log"), full.names = TRUE)
  ...
  save.image(file=paste0(folder, "/RData/validationPlotEnvironment.RData"))
  ...
  p.qq_div_rate <- p.qq_div_rate+
    ...
    ggtitle("Diversification rate") + theme(text=element_text(size=18))
  ...
  ggsave(plot=p.qq_div_rate,paste0(folder, "/figures/qq_diversificationRate", ".pdf"),width=6, height=5)
  ...
  ggsave(plot=p.diversificationRate,paste0(folder, "/figures/diversificationRate", ".pdf"),width=6, height=5)
  ...
  ggsave(plot=p.diversificationRate_log,paste0(folder, "/figures/diversificationRate_logScale", ".pdf"),width=6, height=5)
  ...
  # ggsave(plot=p_rel_err_diversificationRate,paste0(folder, "/figures/diversificationRate_rel_err_median", ".pdf"),width=6, height=5)
  # 
  ...
  # ggsave(plot=p_rel_err_mean_diversificationRate,paste0(folder, "/figures/diversificationRate_rel_err_mean", ".pdf"),width=6, height=5)
  # 
  ...
  # ggsave(plot=p_hpd.rel.width.diversificationRate,paste0(folder, "/figures/diversificationRate_rel_hpd_width", ".pdf"),width=6, height=5)
  ...
  p.qq_turnover <- p.qq_turnover+
    ...
    ggtitle("Turnover") + theme(text=element_text(size=18))
  
  ggsave(plot=p.qq_turnover,paste0(folder, "/figures/qq_turnover", ".pdf"),width=6, height=5)
  ...
  ggsave(plot=p.turnover,paste0(folder, "/figures/turnover", ".pdf"),width=6, height=5)
  ...
  ggsave(plot=p.turnover_log,paste0(folder, "/figures/turnover_logScale", ".pdf"),width=6, height=5)
  
  # hpd.test = data.frame("Parameter"=c('turnover'),
  #                       "HPD coverage"=c(mean(turnover$test)))
  # write.csv(hpd.test, file = paste0(folder, "/figures/turnover_HPD_test",".csv" ))
  # 
  # hpd.width = data.frame("Parameter"=c('turnover'),
  #                        "Average relative HPD width"=c(mean(turnover$hpd.rel.width)))
  # write.csv(hpd.width, file = paste0(folder, "/figures/turnover_HPD_rel_width_score_",".csv" ))
  # 
  # cv = data.frame("Parameter"=c('turnover'),
  #                 "Average Coefficient of Variation"=c(mean(turnover$cv)))
  # write.csv(cv, file = paste0(folder, "/figures/turnover_CV_score",".csv" ))
  # 
  # medians = data.frame("Parameter"=c('turnover'),
  #                      "Medians"=c(mean(turnover$rel.err.meadian)))
  # write.csv(medians, file = paste0(folder, "/figures/turnover_rel_error_median",".csv" ))
  # 
  # means = data.frame("Parameter=c('turnover')", "Means"=c(mean(turnover$rel.err.mean)))
  # write.csv(means, file = paste0(folder, "/figures/turnover_rel_error_mean",".csv"))
  # 
  # 
  ...
  # ggsave(plot=p_rel_err_turnover,paste0(folder, "/figures/turnover_rel_err_median", ".pdf"),width=6, height=5)
  # 
  ...
  # ggsave(plot=p_rel_err_mean_turnover,paste0(folder, "/figures/turnover_rel_err_mean", ".pdf"),width=6, height=5)
  # 
  ...
  # ggsave(plot=p_hpd.rel.width.turnover,paste0(folder, "/figures/turnover_rel_hpd_width", ".pdf"),width=6, height=5)
  ...
  ggsave(plot=p.mrca,paste0(folder, "/figures/mrca", ".pdf"),width=6, height=5)
  ...
  ggsave(plot=p.mrca_log,paste0(folder, "/figures/mrca_logScale", ".pdf"),width=6, height=5)
  ...
  p.qq_origin <- p.qq_origin+
    stat_summary(data=dd, aes(x=p, y=vals),fun.data = "mean_cl_boot", colour = "blue") +
    ggtitle("Origin") + theme(text=element_text(size=18))
  
  ggsave(plot=p.qq_origin,paste0(folder, "/figures/qq_origin", ".pdf"),width=6, height=5)
  ...
  ggsave(plot=p.origin,paste0(folder, "/figures/origin", ".pdf"),width=6, height=5)
  ...
  ggsave(plot=p.origin_log,paste0(folder, "/figures/origin_logScale", ".pdf"),width=6, height=5)
  ...
  p.qq_samplingAtPresentProb <- p.qq_samplingAtPresentProb+
    stat_summary(data=dd, aes(x=p, y=vals),fun.data = "mean_cl_boot", colour = "blue") +
    ggtitle("Sampling At Present Prob.") + theme(text=element_text(size=18))
  
  ggsave(plot=p.qq_samplingAtPresentProb,paste0(folder, "/figures/qq_samplingAtPresentProb", ".pdf"),width=6, height=5)
  ...
  ggsave(plot=p.samplingAtPresentProb,paste0(folder, "/figures/samplingAtPresentProb", ".pdf"),width=6, height=5)
  ...
  ggsave(plot=p.samplingAtPresentProb_log,paste0(folder, "/figures/samplingAtPresentProb_logScale", ".pdf"),width=6, height=5)
  ...
  p.qq_samplingProportion <- p.qq_samplingProportion+
    stat_summary(data=dd, aes(x=p, y=vals),fun.data = "mean_cl_boot", colour = "blue") +
    ggtitle("Sampling Proportion") + theme(text=element_text(size=18))
  
  ggsave(plot=p.qq_samplingProportion,paste0(folder, "/figures/qq_samplingProportion", ".pdf"),width=6, height=5)
  ...
  ggsave(plot=p.samplingProportion,paste0(folder, "/figures/samplingProportion", ".pdf"),width=6, height=5)
  ...
  ggsave(plot=p.samplingProportion_log,paste0(folder, "/figures/samplingProportion_logScale", ".pdf"),width=6, height=5)
  ...
  hpd.test = data.frame("Parameter"=c('diversificationRate',
                        ...
                        "HPD coverage"=c(mean(diversificationRate$test_95),
                                         ...
                                         mean(mrca$test_95),
                                         mean(origin$test_95)))
  write.csv(hpd.test, file = paste0(folder, "/figures/HPD_test",".csv" ))
  ...
  write.csv(hpd.width, file = paste0(folder, "/figures/HPD_rel_width_score_",".csv" ))
  ...
  cv = data.frame("Parameter"=c('diversificationRate',
                  ...
                  "Average Coefficient of Variation"=c(mean(diversificationRate$cv),
                                                       ...
                                                       mean(mrca$cv),
                                                       mean(origin$cv)))
  write.csv(cv, file = paste0(folder, "/figures/CV_score",".csv" ))
  ...
  write.csv(medians, file = paste0(folder, "/figures/rel_error_median",".csv" ))
  ...
  write.csv(means, file = paste0(folder, "/figures/rel_error_mean",".csv"))
}
